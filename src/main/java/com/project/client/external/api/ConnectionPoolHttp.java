...
public class ConnectionPoolHttp {
    ...
    public List<String> getProductsBySimilarity(String id) throws IOException {
        ...
        if (execute.getStatusLine().getStatusCode() == 404) throw new IOException("Product not found");
     ...
     */
    public List<Product> getProductDetails(List<String> ids) throws IOException, ExecutionException, InterruptedException {
     ...
     */
    @NotNull
    private List<Product> getFutureResponses(List<Future<CloseableHttpResponse>> futures) throws IOException, ExecutionException, InterruptedException {
     ...
     */
    @NotNull
    private List<Future<CloseableHttpResponse>> generateAsyncTasks(List<String> ids, ExecutorService executor) {
